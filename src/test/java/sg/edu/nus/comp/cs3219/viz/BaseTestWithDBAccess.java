...
//
//        authorRecordRepository.saveAll(dataBundle.authorUploadRequest.getRecordList());
//        reviewRecordRepository.saveAll(dataBundle.reviewUploadRequest.getRecordList());
//        submissionRecordRepository.saveAll(dataBundle.submissionUploadRequest.getRecordList());
//    }
//
//    @After
