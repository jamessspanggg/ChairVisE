    ...
    >
      <div class="title" v-if="!isEditing">
        ...
        <el-button
          type="success"
          plain
          @click="openCopyPresentationPanel()"
          v-if="isPresentationEditable"
        >Copy</el-button>
        <el-button
          type="danger"
        ...
        >
          <Copy-Presentation-Panel
            v-bind:presentationId="this.presentationId"
            v-bind:sectionId="this.sectionDetail.id"
          ></Copy-Presentation-Panel>
        </el-dialog>
      </div>
      ...
      <el-alert
        ...
        class="errorMessage"
      ></el-alert>
      <el-alert v-if="!this.hasData" title="No Data to display" type="info" class="noDataToDisplay"></el-alert>
      <slot v-else></slot>
      <div v-if="!isEditing" class="description">{{ editForm.description }}</div>
      <div v-if="isEditing">
        <el-form-item label="Editing Mode">
          <el-switch v-model="isInAdvancedMode" active-text="Advanced" inactive-text="Basic"></el-switch>
        </el-form-item>
